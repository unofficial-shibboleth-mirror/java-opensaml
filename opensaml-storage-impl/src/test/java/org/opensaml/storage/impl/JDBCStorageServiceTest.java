...
public class JDBCStorageServiceTest extends StorageServiceTest {
    ...
    private static final String INIT_FILE = "/org/opensaml/storage/impl/RdbmsStore.sql";
    ...
    @BeforeClass public void setUp() throws ComponentInitializationException {
        try {
            ...
            final InputStream is = getClass().getResourceAsStream(INIT_FILE);
            final String sql = StringSupport.trimOrNull(CharStreams.toString(new InputStreamReader(is)));
    ...
    @Test(dataProvider = "contexts", singleThreaded = false, threadPoolSize = 25, invocationCount = 100, enabled = false)
    ...
    @Test(singleThreaded = false, threadPoolSize = 25, invocationCount = 100, enabled = false)
