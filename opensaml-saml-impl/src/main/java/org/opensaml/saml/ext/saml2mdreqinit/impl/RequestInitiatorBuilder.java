...
public class RequestInitiatorBuilder extends AbstractSAMLObjectBuilder<RequestInitiator> {
    ...
    /** {@inheritDoc} */
    @Override
    @Nonnull public RequestInitiator buildObject(@Nullable final String namespaceURI, @Nonnull final String localName,
