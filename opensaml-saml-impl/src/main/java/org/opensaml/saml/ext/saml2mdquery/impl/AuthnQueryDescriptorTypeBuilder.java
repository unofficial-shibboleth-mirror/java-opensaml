...
public class AuthnQueryDescriptorTypeBuilder extends AbstractSAMLObjectBuilder<AuthnQueryDescriptorType> {
    ...
    /** {@inheritDoc} */
    @Override
    @Nonnull public AuthnQueryDescriptorType buildObject(@Nullable final String namespaceURI,
