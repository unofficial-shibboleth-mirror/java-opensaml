...
public class ActionNamespaceBuilder extends AbstractSAMLObjectBuilder<ActionNamespace> {
    ...
    /** {@inheritDoc} */
    @Override
    @Nonnull public ActionNamespace buildObject(@Nullable final String namespaceURI, @Nonnull final String localName,
