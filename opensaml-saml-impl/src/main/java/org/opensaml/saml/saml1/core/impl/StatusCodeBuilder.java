...
public class StatusCodeBuilder extends AbstractSAMLObjectBuilder<StatusCode> {
    ...
    /** {@inheritDoc} */
    @Override
    @Nonnull public StatusCode buildObject(@Nullable final String namespaceURI, @Nonnull final String localName,
