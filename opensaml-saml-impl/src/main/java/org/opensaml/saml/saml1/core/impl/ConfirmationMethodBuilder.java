...
public class ConfirmationMethodBuilder extends AbstractSAMLObjectBuilder<ConfirmationMethod> {
    ...
    /** {@inheritDoc} */
    @Override
    @Nonnull public ConfirmationMethod buildObject(@Nullable final String namespaceURI, @Nonnull final String localName,
