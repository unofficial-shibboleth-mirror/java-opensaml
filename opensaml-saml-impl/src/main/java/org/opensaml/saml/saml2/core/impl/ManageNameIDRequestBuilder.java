...
public class ManageNameIDRequestBuilder extends AbstractSAMLObjectBuilder<ManageNameIDRequest> {
    ...
    /** {@inheritDoc} */
    @Override
    @Nonnull public ManageNameIDRequest buildObject(@Nullable final String namespaceURI,
