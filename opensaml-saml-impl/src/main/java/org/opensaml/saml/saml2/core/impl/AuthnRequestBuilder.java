...
public class AuthnRequestBuilder extends AbstractSAMLObjectBuilder<AuthnRequest> {
    ...
    /** {@inheritDoc} */
    @Override
    @Nonnull public AuthnRequest buildObject(@Nullable final String namespaceURI, @Nonnull final String localName,
