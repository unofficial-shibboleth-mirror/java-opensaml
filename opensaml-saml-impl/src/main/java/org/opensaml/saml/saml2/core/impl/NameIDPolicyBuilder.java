...
public class NameIDPolicyBuilder extends AbstractSAMLObjectBuilder<NameIDPolicy> {
    ...
    /** {@inheritDoc} */
    @Override
    @Nonnull public NameIDPolicy buildObject(@Nullable final String namespaceURI, @Nonnull final String localName,
