...
public class AudienceRestrictionBuilder extends AbstractSAMLObjectBuilder<AudienceRestriction> {
    ...
    /** {@inheritDoc} */
    @Override
    @Nonnull public AudienceRestriction buildObject(@Nullable final String namespaceURI,
