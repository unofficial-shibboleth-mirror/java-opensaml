...
public class TelephoneNumberBuilder extends AbstractSAMLObjectBuilder<TelephoneNumber> {
    ...
    /** {@inheritDoc} */
    @Override
    @Nonnull public TelephoneNumber buildObject(@Nullable final String namespaceURI, @Nonnull final String localName,
