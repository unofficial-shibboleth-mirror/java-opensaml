...
public class EncryptedIDBuilder extends AbstractSAMLObjectBuilder<EncryptedID> {
    ...
    /** {@inheritDoc} */
    @Override
    @Nonnull public EncryptedID buildObject(@Nullable final String namespaceURI, @Nonnull final String localName,
