...
public class SubjectLocalityBuilder extends AbstractSAMLObjectBuilder<SubjectLocality> {
    ...
    /** {@inheritDoc} */
    @Override
    @Nonnull public SubjectLocality buildObject(@Nullable final String namespaceURI, @Nonnull final String localName,
