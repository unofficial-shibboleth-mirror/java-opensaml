...
public class KeyInfoConfirmationDataTypeBuilder extends AbstractSAMLObjectBuilder<KeyInfoConfirmationDataType> {
    ...
    /** {@inheritDoc} */
    @Override
    @Nonnull public KeyInfoConfirmationDataType buildObject(@Nullable final String namespaceURI,
