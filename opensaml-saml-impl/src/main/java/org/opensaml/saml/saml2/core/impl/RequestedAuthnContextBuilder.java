...
public class RequestedAuthnContextBuilder extends AbstractSAMLObjectBuilder<RequestedAuthnContext> {
    ...
    /** {@inheritDoc} */
    @Override
    @Nonnull public RequestedAuthnContext buildObject(@Nullable final String namespaceURI,
