...
public class RequesterIDBuilder extends AbstractSAMLObjectBuilder<RequesterID> {
    ...
    /** {@inheritDoc} */
    @Override
    @Nonnull public RequesterID buildObject(@Nullable final String namespaceURI, @Nonnull final String localName,
