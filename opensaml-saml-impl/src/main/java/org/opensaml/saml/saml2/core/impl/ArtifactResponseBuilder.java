...
public class ArtifactResponseBuilder extends AbstractSAMLObjectBuilder<ArtifactResponse> {
    ...
    /** {@inheritDoc} */
    @Override
    @Nonnull public ArtifactResponse buildObject(@Nullable final String namespaceURI, @Nonnull final String localName,
