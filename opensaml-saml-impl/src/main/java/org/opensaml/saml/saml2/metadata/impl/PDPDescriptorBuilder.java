...
public class PDPDescriptorBuilder extends AbstractSAMLObjectBuilder<PDPDescriptor> {
    ...
    /** {@inheritDoc} */
    @Override
    @Nonnull public PDPDescriptor buildObject(@Nullable final String namespaceURI, @Nonnull final String localName,
