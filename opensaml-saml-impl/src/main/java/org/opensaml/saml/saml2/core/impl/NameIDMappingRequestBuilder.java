...
public class NameIDMappingRequestBuilder extends AbstractSAMLObjectBuilder<NameIDMappingRequest> {
    ...
    /** {@inheritDoc} */
    @Override
    @Nonnull public NameIDMappingRequest buildObject(@Nullable final String namespaceURI,
