...
public class AssertionIDRequestBuilder extends AbstractSAMLObjectBuilder<AssertionIDRequest> {
    ...
    /** {@inheritDoc} */
    @Override
    @Nonnull public AssertionIDRequest buildObject(@Nullable final String namespaceURI, @Nonnull final String localName,
