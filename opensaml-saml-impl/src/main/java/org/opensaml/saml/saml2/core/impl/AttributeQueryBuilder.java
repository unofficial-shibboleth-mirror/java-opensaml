...
public class AttributeQueryBuilder extends AbstractSAMLObjectBuilder<AttributeQuery> {
    ...
    /** {@inheritDoc} */
    @Override
    @Nonnull public AttributeQuery buildObject(@Nullable final String namespaceURI, @Nonnull final String localName,
