...
public class ArtifactResolveBuilder extends AbstractSAMLObjectBuilder<ArtifactResolve> {
    ...
    /** {@inheritDoc} */
    @Override
    @Nonnull public ArtifactResolve buildObject(@Nullable final String namespaceURI, @Nonnull final String localName,
