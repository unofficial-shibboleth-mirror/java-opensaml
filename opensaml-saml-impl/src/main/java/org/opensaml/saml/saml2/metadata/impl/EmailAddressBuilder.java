...
public class EmailAddressBuilder extends AbstractSAMLObjectBuilder<EmailAddress> {
    ...
    /** {@inheritDoc} */
    @Override
    @Nonnull public EmailAddress buildObject(@Nullable final String namespaceURI, @Nonnull final String localName,
