...
public class AuthnQueryServiceBuilder extends AbstractSAMLObjectBuilder<AuthnQueryService> {
    ...
    /** {@inheritDoc} */
    @Override
    @Nonnull public AuthnQueryService buildObject(@Nullable final String namespaceURI, @Nonnull final String localName,
