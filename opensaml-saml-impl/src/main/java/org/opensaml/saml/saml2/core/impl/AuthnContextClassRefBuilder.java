...
public class AuthnContextClassRefBuilder extends AbstractSAMLObjectBuilder<AuthnContextClassRef> {
    ...
    /** {@inheritDoc} */
    @Override
    @Nonnull public AuthnContextClassRef buildObject(@Nullable final String namespaceURI,
