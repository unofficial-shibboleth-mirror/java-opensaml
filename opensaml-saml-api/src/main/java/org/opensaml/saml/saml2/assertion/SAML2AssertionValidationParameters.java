...
public final class SAML2AssertionValidationParameters {
    ...
    @Nonnull public static final String STD_PREFIX = "saml2";
    
    /** The standard infix for parameters concerned with subject confirmation. */
    @Nonnull public static final String SC_INFIX = ".SubjectConfirmation";
    
    /** The standard infix for parameters concerned with conditions evaluation. */
    @Nonnull public static final String COND_INFIX = ".Conditions";
    
    /** The standard infix for parameters concerned with statement evaluation. */
    @Nonnull public static final String STMT_INFIX = ".Statement";
    
    /**
     * Carries a {@link java.time.Duration} specifying a clock skew value.
     */
    @Nonnull public static final String CLOCK_SKEW = STD_PREFIX + ".ClockSkew";

    /**
     * Carries a {@link java.time.Duration} specifying a lifetime from 'now' for IssueInstant.
     */
    @Nonnull public static final String LIFETIME = STD_PREFIX + ".Lifetime";

    /**
     * Carries the {@link org.opensaml.saml.saml2.core.SubjectConfirmation} that confirmed the subject.
     */
    @Nonnull public static final String CONFIRMED_SUBJECT_CONFIRMATION = STD_PREFIX + ".ConfirmedSubjectConfirmation";
     ...
     */
    @Nonnull public static final String VALID_ISSUERS = STD_PREFIX + ".ValidIssuers";

    /**
     * Carries a {@link java.lang.Boolean} flag which indicates whether the Assertion is required to be signed.
     */
    @Nonnull public static final String SIGNATURE_REQUIRED = STD_PREFIX + ".SignatureRequired";
     ...
     */
    @Nonnull public static final String SIGNATURE_VALIDATION_CRITERIA_SET = STD_PREFIX + ".SignatureValidationCriteriaSet";
     ...
     */
    @Nonnull public static final String SIGNATURE_VALIDATION_TRUST_ENGINE = STD_PREFIX + ".SignatureValidationTrustEngine";
     ...
     * 
     */
    @Nonnull public static final String SIGNATURE_VALIDATION_PREVALIDATOR = STD_PREFIX + ".SignatureValidationPrevalidator";
     ...
     */
    @Nonnull public static final String SC_NOT_BEFORE_REQUIRED = STD_PREFIX + SC_INFIX + ".NotBeforeRequired";
    
    /**
     * Carries a {@link java.lang.Boolean} flag which indicates whether
     * {@link org.opensaml.saml.saml2.core.SubjectConfirmationData} NotOnOrAfter is required.
     */
    @Nonnull public static final String SC_NOT_ON_OR_AFTER_REQUIRED = STD_PREFIX + SC_INFIX + ".NoOnOrAfterRequired";
    
    /**
     * Carries a {@link java.lang.Boolean} flag which indicates whether
     * {@link org.opensaml.saml.saml2.core.SubjectConfirmationData} Recipient is required.
     */
    @Nonnull public static final String SC_RECIPIENT_REQUIRED = STD_PREFIX + SC_INFIX + ".RecipientRequired";
     ...
     */
    @Nonnull public static final String SC_VALID_RECIPIENTS = STD_PREFIX + SC_INFIX + ".ValidRecipients";
     ...
     */
    @Nonnull public static final String SC_ADDRESS_REQUIRED = STD_PREFIX + SC_INFIX + ".AddressRequired";

    /**
     * Carries a {@link java.lang.Boolean} flag which indicates whether the
     * {@link org.opensaml.saml.saml2.core.SubjectConfirmationData} address should be checked.
     */
    @Nonnull public static final String SC_CHECK_ADDRESS = STD_PREFIX + SC_INFIX + ".CheckAddress";
     ...
     */
    @Nonnull public static final String SC_VALID_ADDRESSES = STD_PREFIX + SC_INFIX + ".ValidAddresses";
    
    /**
     * Carries a {@link java.lang.Boolean} flag which indicates whether
     * {@link org.opensaml.saml.saml2.core.SubjectConfirmationData} InResponseTo is required.
     */
    @Nonnull public static final String SC_IN_RESPONSE_TO_REQUIRED = STD_PREFIX + SC_INFIX + ".InResponseToRequired";
     ...
     */
    @Nonnull public static final String SC_VALID_IN_RESPONSE_TO = STD_PREFIX + SC_INFIX + ".ValidInResponseTo";
    
    /**
     * Carries the {@link java.security.PublicKey} used by the presenter.
     */
    @Nonnull public static final String SC_HOK_PRESENTER_KEY = STD_PREFIX + SC_INFIX + ".HoK.PresenterKey";

    /**
     * Carries the {@link java.security.cert.X509Certificate} used by the presenter.
     */
    @Nonnull public static final String SC_HOK_PRESENTER_CERT = STD_PREFIX + SC_INFIX + ".HoK.PresenterCertificate";
     ...
     */
    @Nonnull public static final String SC_HOK_CONFIRMED_KEYINFO = STD_PREFIX + SC_INFIX + ".HoK.ConfirmedKeyInfo";
     ...
     */
    @Nonnull public static final String COND_REQUIRED_CONDITIONS = STD_PREFIX + COND_INFIX + ".RequiredConditions";
     ...
     */
    @Nonnull public static final String COND_VALID_AUDIENCES = STD_PREFIX + COND_INFIX + ".ValidAudiences";

    /**
     * Carries a {@link java.time.Duration} representing the per-invocation value for the Assertion 
     * replay cache expiration.
     */
    @Nonnull public static final String COND_ONE_TIME_USE_EXPIRES = STD_PREFIX + COND_INFIX + ".OneTimeUseExpires";
     ...
     * should be checked.
     */
    @Nonnull public static final String STMT_AUTHN_CHECK_ADDRESS = 
     ...
     */
    @Nonnull public static final String STMT_AUTHN_VALID_ADDRESSES = 
     ...
     */
    @Nonnull public static final String STMT_AUTHN_MAX_TIME = STD_PREFIX + STMT_INFIX + ".Authn.MaxTimeSinceAuthn";
