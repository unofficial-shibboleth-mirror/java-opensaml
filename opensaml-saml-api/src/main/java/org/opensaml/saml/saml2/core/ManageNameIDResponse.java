...
public interface ManageNameIDResponse extends StatusResponseType {
    ...
    /** Element local name. */
    @Nonnull public static final String DEFAULT_ELEMENT_LOCAL_NAME = "ManageNameIDResponse";
    ...
    @Nonnull public static final String TYPE_LOCAL_NAME = "ManageNameIDResponseType";
