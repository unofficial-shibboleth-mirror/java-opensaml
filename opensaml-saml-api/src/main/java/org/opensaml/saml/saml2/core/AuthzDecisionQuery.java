...
public interface AuthzDecisionQuery extends SubjectQuery {
    ...
    /** Element local name. */
    @Nonnull public static final String DEFAULT_ELEMENT_LOCAL_NAME = "AuthzDecisionQuery";
    ...
    @Nonnull public static final String TYPE_LOCAL_NAME = "AuthzDecisionQueryType";
