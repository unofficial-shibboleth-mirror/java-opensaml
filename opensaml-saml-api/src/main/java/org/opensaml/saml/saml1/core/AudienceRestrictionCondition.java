...
public interface AudienceRestrictionCondition extends Condition {
    ...
    @Nonnull public static final String DEFAULT_ELEMENT_LOCAL_NAME = "AudienceRestrictionCondition";
    ...
    @Nonnull public static final String TYPE_LOCAL_NAME = "AudienceRestrictionConditionType"; 
