...
public interface SubjectStatement extends SAMLObject, Statement {
    ...
    @Nonnull public static final String DEFAULT_ELEMENT_LOCAL_NAME = "SubjectStatement";
    ...
    @Nonnull public static final String TYPE_LOCAL_NAME = "SubjectStatementAbstractType"; 
